...
# Load the full data
full_data<-read.csv("Brass_subset.csv")

# So the model with macros * time - note here I ignore the GDP model as we are confined to the high GDP countries
...
CairoPDF("Figure_6.pdf", height=20, width=15)
