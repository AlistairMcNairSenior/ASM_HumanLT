...
write.GAM(GAM_supply, csv.file="Table_S15_(supply_time_IMP).csv")
...
write.GAM(GAM_GDP, csv.file="Table_S16_(GDP_time_IMP).csv")
...
pdf("Figure_S1.pdf", height=10, width=12)
