...
# Note here we are using the complete cases analysis to cover the portion of the space in the complete cases analysis
...
CairoPDF("figures/Figure_S10.pdf", height=20, width=15)
