...
combined$Food_group[group5]<-"Protein_vegetable.g"
...
wide$Protein_vegetable.kcal<-wide$Value.Protein_vegetable.g * 4
wide$Protein_animal.kcal<-wide$Value.Protein_animal.g * 4
wide$Prop_animal_prot<-wide$Protein_animal.kcal / wide$Protein.kcal

# Clean out some more
wide<-wide[,c("Area", "Year", "Protein.kcal", "Carbo.kcal", "Fat.kcal", "Alcohol.kcal", "Prop_animal_prot")]
