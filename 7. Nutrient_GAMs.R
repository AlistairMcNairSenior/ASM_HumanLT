...
write.table(AIC_table, file="tables/Table_S6.csv", sep=",", row.names=F, col.names=colnames(AIC_table))
...
# Create Table S7
write.GAM(AIC_favoured_models[[1]], csv.file="tables/Table_S7_males(complete_cases).csv")
write.GAM(AIC_favoured_models[[2]], csv.file="tables/Table_S7_females(complete_cases).csv")
...
# Create Table S8
write.GAM(AIC_favoured_models[[1]], csv.file="tables/Table_S8_males(subset).csv")
write.GAM(AIC_favoured_models[[2]], csv.file="tables/Table_S8_females(subset).csv")

# NOTE table S9 is the LMM coefficients in the script 4. Estimate_Brass

# tables S10 and S11 are the associations between GDP/nutrient supply and time in the script for Figure S4
...
write.GAM(AIC_favoured_models[[1]], csv.file="tables/Table_S12_males(imputed).csv")
write.GAM(AIC_favoured_models[[2]], csv.file="tables/Table_S12_females(imputed).csv")
...
write.GAM(AIC_favoured_models[[1]], csv.file="tables/Table_S13_males(random1_subset).csv")
write.GAM(AIC_favoured_models[[2]], csv.file="tables/Table_S13_females(random1_subset).csv")
...
write.GAM(AIC_favoured_models[[1]], csv.file="tables/Table_S14_males(random2_subset).csv")
write.GAM(AIC_favoured_models[[2]], csv.file="tables/Table_S14_females(random2_subset).csv")
